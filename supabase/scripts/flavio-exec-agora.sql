-- =====================================================================
-- FLÁVIO TEST DATA - COMPLETE EXECUTION
-- Cria função + insere dados + valida TUDO DE UMA VEZ
-- Cole tudo isto no Supabase Dashboard SQL Editor e clique Run
-- =====================================================================

-- 1. CRIAR FUNÇÃO (se ainda não existir)
DROP FUNCTION IF EXISTS insert_flavio_test_data() CASCADE;

CREATE FUNCTION insert_flavio_test_data()
RETURNS TABLE(contadores_total int, clientes_total int, bonus_total int) AS $$
BEGIN
